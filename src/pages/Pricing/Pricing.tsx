...
const includedFeatures = [
    ...
    'Translate, rewrite and AI detection',
    'Book one to one session with our experts',
]
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl sm:text-center">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-600">
                        Just pay once and enjoy our premium service for a whole month
                    </p>
                </div>
                <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                    <div className="p-8 sm:p-10 lg:flex-auto">
                        <h3 className="text-2xl font-bold tracking-tight text-gray-900">One-month membership</h3>
                        <p className="mt-6 text-base leading-7 text-gray-600">
                            Enjoy our premium service for a whole month. No limits. No tricks. No hidden charges.
                        </p>
