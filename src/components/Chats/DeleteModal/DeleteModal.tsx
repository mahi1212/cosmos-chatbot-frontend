...
import { chatIdAtom, deleteModalAtom, titleAtom } from 'src/store/jotai'
import { deleteSingleChat } from 'src/helpers/api-communicator'
import toast from 'react-hot-toast'


const DeleteModal: React.FC<{ id: string }> = ({ id }) => {
                                    ...
                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                Are you sure you want to delete your chat? All of your data will be permanently removed. This action cannot be undone.
                                            </p>
                                        </div>
                                    </div>
                                </div>
